...
/* 리덕스를 관리할 컴포넌트를 감싸주는 Provider 컴포넌트와 리덕스 관련 
Hook을 위한 패키지 임포트 */
...
Provider
: 어떤 컴포넌트에 State를 제공할지를 결정하는 Wrapper 컴포넌트로 여기서는
App 컴포넌트 하위의 <Left>, <Right> 컴포넌트를 감싸준다. 그러면 하위
...
const Left3 = () => {
  /*
  Store에 정의된 여러개의 State 중 어떤값을 받을지 정의한 함수를
...
function App() {
  ...
  return (
    <div className="root">
      ...
      <h2>React - Redux</h2>
      <div id="grid">
        {/* 하위 컴포넌트를 Wrapping하면 Store를 사용할 수 있게된다. */}
