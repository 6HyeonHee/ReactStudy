...
const Right3 = (props) => {
  ...
  함수를 호춯한다. 그러면 Right3->Right2...->App과 같은 순서대로 호출된다.
  즉, +버튼을 누르면 State인 number가 1 증가되면서 새롭게 렌더링 된다.
  */
  return (
    <div>
      <h2>Right3</h2>
...
실제 애플리케이션은 이와같이 중첩된 구조의 UI를 가지게 되므로 여러 Depth의
컴포넌트 구조를 가지게 된다.
*/
const Left1 = (props) => {
  return (
...
function App() {
  ...
  return (
    <div className="root">
      ...
      <div id="grid">
        {/* Left 컴포넌트 하위에는 number를 Props로 전달 */}
